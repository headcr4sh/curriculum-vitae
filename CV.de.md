...
Integration von [SonarQube](https://sonarqube.org/) in CI/CD Build Pipelines, welche mit [Concourse CI](https://concourse-ci.org/) erstellt wurden.\
\
